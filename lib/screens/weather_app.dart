...
class _WeatherAppState extends State<WeatherApp> {
  ...
  Widget build(BuildContext context) {
    if (locationList[_currenPage].weatherType == 'Sunny') {
      bgImg = 'assets/sunny.jpg';
    } else if (locationList[_currenPage].weatherType == 'Night') {
      bgImg = 'assets/night.jpg';
    } else if (locationList[_currenPage].weatherType == 'Rainy') {
      bgImg = 'assets/rainy.jpg';
    } else if (locationList[_currenPage].weatherType == 'Cloudy') {
              ...
              child: Row(
                children: [
                  for (int i = 0; i < locationList.length; i++)
                    if (i == _currenPage) SliderDot(true) else SliderDot(false)
                ],
              ),
            ),
            TransformerPageView(
